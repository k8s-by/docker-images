build-all:
	...
	(cd github-runner; make build-all)
	...
	(cd postgres-operator; make build-all)
	(cd pgbackup; make build-all)
	(cd pgbackrest; make build-all)
	...
	(cd redis-sentinel-exporter; make build-all)
	(cd redis-sentinel-proxy; make build-all)
	(cd spilo14; make build-all)
...
release-all:
	...
	(cd github-runner; make release-all)
	...
	(cd postgres-operator; make release-all)
	(cd pgbackup; make release-all)
	(cd pgbackrest; make release-all)
	...
	(cd redis-sentinel-exporter; make release-all)
	(cd redis-sentinel-proxy; make release-all)
	(cd spilo14; make release-all)
